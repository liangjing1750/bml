...
本文档面向当前 BLM 浏览器版用户，介绍如何在同一个工作区中完成新建文档、打开文档、复制文档、合并文档、查看历史版本和使用回收站。
...
3. 在左侧目录大纲中点击章节，可直接跳转到正文对应位置。
4. 右侧“图示速览”中的截图可直接点击，页面会定位到正文中的原图。

这个页签适合在建模过程中边看规范边修改，不需要离开当前系统去单独翻阅 Markdown 文件。
...
- 新建文档后会生成一个默认主流程。
- 首次创建完成后，文档已经进入工作区，不需要再单独选择保存位置。
...
如果界面发生变化，需要同步更新本文中的截图。项目已提供自动截图脚本：
